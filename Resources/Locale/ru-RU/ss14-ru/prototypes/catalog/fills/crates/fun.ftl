...
ent-CrateFunATV = ящик с квадроциклом
    .desc = Абсолютно Налогооблагаемое Транспортное Средство, которое поможет грузчикам с перевозками.
...
ent-CrateFunSyndicateSegway = ящик с сегвеем Синдиката
    .desc = Ящик с двухколёсником, который поможет вам уехать от офицеров службы безопасности. Или нет.
