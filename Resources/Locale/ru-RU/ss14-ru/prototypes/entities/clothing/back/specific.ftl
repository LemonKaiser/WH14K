...
ent-XenoborgMaterialBag = синтетическое хранилище материалов
    .desc = Поддельная версия бездонного мешка. Может всасывать материалы, непригодный для использования гуманоидами из-за вредных выбросов.
