...
ent-RipleyLArm = левая рука Рипли
    .desc = Левая рука меха «Рипли АВП». Должна крепиться к шасси меха.
ent-RipleyLLeg = левая нога Рипли
    .desc = Левая нога меха «Рипли АВП». Должна крепиться к шасси меха.
ent-RipleyRLeg = правая нога Рипли
    .desc = Правая нога меха «Рипли АВП». Должна крепиться к шасси меха.
ent-RipleyRArm = правая рука Рипли
    .desc = Правая рука меха «Рипли АВП». Должна крепиться к шасси меха.
ent-RipleyChassis = шасси Рипли
    .desc = Незавершённая сборка меха «Рипли АВП».
...
ent-HonkerLArm = левая рука Х.О.Н.К.
    .desc = Левая рука меха «Х.О.Н.К.» с уникальными креплениями под странное вооружение, разработанное клоунами-учёными.
ent-HonkerLLeg = левая нога Х.О.Н.К.
    .desc = Левая нога меха «Х.О.Н.К.». Кажется, ступня как раз достаточно большая, чтобы полностью вместить клоунский ботинок.
ent-HonkerRLeg = правая нога Х.О.Н.К.
    .desc = Правая нога меха «Х.О.Н.К.». Кажется, ступня как раз достаточно большая, чтобы полностью вместить клоунский ботинок.
ent-HonkerRArm = правая рука Х.О.Н.К.
    .desc = Правая рука меха «Х.О.Н.К.» с уникальными креплениями под странное вооружение, разработанное клоунами-учёными.
ent-HonkerChassis = шасси Х.О.Н.К.
    .desc = Незавершённая сборка меха «Х.О.Н.К.». Содержит модуль хихиканья, бананиумное ядро и системы поддержки хонка.
...
ent-HamtrLArm = левая рука ХАМЯК
    .desc = Левая рука меха «ХАМЯК». Должна крепиться к шасси меха.
ent-HamtrLLeg = левая нога ХАМЯК
    .desc = Левая нога меха «ХАМЯК». Должна крепиться к шасси меха.
ent-HamtrRLeg = правая нога ХАМЯК
    .desc = Правая нога меха «ХАМЯК». Должна крепиться к шасси меха.
ent-HamtrRArm = правая рука ХАМЯК
    .desc = Правая рука меха «ХАМЯК». Должна крепиться к шасси меха.
ent-HamtrChassis = шасси ХАМЯК
    .desc = Незавершённая сборка меха «ХАМЯК».
ent-BaseVimPart = { ent-BaseMechPart }
    .desc = { ent-BaseMechPart.desc }
ent-BaseVimPartItem = { ent-BaseVimPart }
    .desc = { ent-BaseVimPart.desc }
ent-VimHarness = каркас ВИМ
    .desc = Небольшой кронштейн для деталей ВИМ.
ent-VimChassis = шасси ВИМ
    .desc = Незавершённая сборка экзокостюма «ВИМ».
