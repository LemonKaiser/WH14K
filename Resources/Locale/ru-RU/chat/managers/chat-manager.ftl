...
chat-manager-repeat-rate-limited = Вы слишком часто повторяете одно и то же сообщение!
chat-manager-repeat-rate-limit-admin-announcement = Предупреждение о повторяющемся спаме: { $player } - { $message }
chat-manager-rate-limit-auto-muted = Вы автоматически получили мут чата на { $minutes } мин. за флуд.
chat-manager-repeat-rate-limit-auto-muted = Вы автоматически получили мут чата на { $minutes } мин. за повторяющийся спам.
chat-manager-rate-limit-auto-mute-reason = Автоматический мут чата: превышен лимит сообщений.
chat-manager-repeat-rate-limit-auto-mute-reason = Автоматический мут чата: повторяющийся спам.
...
chat-speech-verb-sheep-2 = мекает
...
chat-speech-verb-vulpkanin = Кровогор
