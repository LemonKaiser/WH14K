...
uplink-energy-dome-name = Персональный энергодом
uplink-energy-dome-desc = Персональный генератор щита, который защищает носителя от лазеров и пуль. Поставляется с малой батареей.
