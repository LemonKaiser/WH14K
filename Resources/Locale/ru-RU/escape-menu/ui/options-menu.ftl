...
ui-options-wh40k-notifications-category-point = Экономика команды
...
ui-options-speech-bubbles-label = Речевые пузыри
...
ui-options-hud-theme-auto = Авто
...
ui-options-general-language-translation = Язык и перевод
ui-options-language = Язык игры:
ui-options-chat-translation-enabled = Включить перевод чата
ui-options-chat-translation-language = Язык перевода чата:
ui-options-chat-translation-language-auto = Как язык игры
...
ui-options-hotkey-toggle-walk = Переключать бег/шаг
...
ui-options-hold-to-attack-melee = Удерживать для атаки в ближнем бою
ui-options-hold-to-attack-ranged = Удерживать для стрельбы
...
ui-options-disable-ai-static = Отключить статический эффект на камере ИИ
ui-options-accessability-header-visuals = Изображение
ui-options-accessability-header-lobby = Лобби
...
ui-options-lobby-background-type-server = По умолчанию сервера
...
ui-options-lobby-panel-opacity = Непрозрачность фона панелей лобби
ui-options-customization-panel-opacity = Непрозрачность фона меню кастомизации
ui-options-ui-window-opacity = Непрозрачность фона окон UI
...
ui-options-speech-bubble-dialogue-blips = Включить звуковые blip-реплики в речевых пузырях
ui-options-speech-bubble-dialogue-blip-volume = Громкость blip-реплик
ui-options-speech-bubble-dialogue-blip-speed = Скорость появления текста реплик
...
ui-options-admin-player-tab-symbol-setting-specific = Показывать уникальный символ антагониста
...
ui-options-admin-player-tab-color-setting-off = Без раскраски
ui-options-admin-player-tab-color-setting-character = Подсвечивать имена персонажей-антагонистов
ui-options-admin-player-tab-color-setting-roletype = Подсвечивать все типы ролей
ui-options-admin-player-tab-color-setting-both = Подсвечивать и то и другое
...
ui-options-admin-overlay-antag-symbol-specific = Показывать уникальный символ антагониста
...
ui-options-admin-overlay-merge-distance = Дистанция слияния меток
ui-options-admin-overlay-ghost-fade-distance = Дистанция начала затухания призрачного оверлея от мыши
ui-options-admin-overlay-ghost-hide-distance = Дистанция скрытия призрачного оверлея от мыши
...
ui-options-overlay-merge-distance = Дистанция слияния меток
ui-options-overlay-ghost-fade-distance = Дистанция начала затухания призрачного оверлея от мыши
ui-options-overlay-ghost-hide-distance = Дистанция скрытия призрачного оверлея от мыши
