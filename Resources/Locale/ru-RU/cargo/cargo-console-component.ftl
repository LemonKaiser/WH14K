...
cargo-console-menu-delivery-time-label = Время в пути груза:{ " " }
cargo-console-menu-delivery-time-none-text = нет данных
cargo-console-menu-delivery-time-arriving-text = прибытие...
