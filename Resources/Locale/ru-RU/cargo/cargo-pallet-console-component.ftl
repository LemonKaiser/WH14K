...
cargo-pallet-menu-total-label = Итоговая стоимость ({$tax}% налог):{" "}
cargo-pallet-menu-no-goods-text = Нет
cargo-pallet-menu-subtitle = Отслеживайте содержимое связанных поддонов, обновляйте оценку и проводите продажу из одного терминала после удержания {$tax}% налога.
...
cargo-pallet-menu-accepted-default = Любые продаваемые товары на связанных торговых поддонах; выплата составляет {$payout}% от полной стоимости
