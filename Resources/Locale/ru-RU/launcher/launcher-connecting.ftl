...
connecting-discord-auth-reauth = Переавторизовать Discord
connecting-discord-auth-retry = Перепроверить Discord
connecting-discord-auth-retry-cooldown = Перепроверить Discord ({ $seconds }с)
