...
ent-MechModuleFan = exosuit fan module
    .desc = Draws outside air into the tank and scrubs the sealed cabin to maintain a breathable atmosphere. Features a built-in filter.
ent-MechModuleAirTank = exosuit air tank module
    .desc = A filled air canister capable of holding a large amount of breathable air for a sealed mech cabin.
