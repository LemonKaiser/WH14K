...
ent-ClarkeHead = clarke head
    .desc = The head of the Clarke. It belongs on the mech chassis.
ent-ClarkeRArm = clarke right arm
    .desc = The right arm of the Clarke. It belongs on the mech chassis.
ent-ClarkeLArm = clarke left arm
    .desc = The left arm of the Clarke. It belongs on the mech chassis.
ent-ClarkeTreads = clarke treads
    .desc = The treads of the Clarke. They belong on the mech chassis.
...
ent-DurandHead = durand head
    .desc = The head of the Durand. It belongs on the mech chassis.
ent-DurandLArm = durand left arm
    .desc = The left arm of the Durand. It belongs on the mech chassis.
ent-DurandLLeg = durand left leg
    .desc = The left leg of the Durand. It belongs on the mech chassis.
ent-DurandRLeg = durand right leg
    .desc = The right leg of the Durand. It belongs on the mech chassis.
ent-DurandRArm = durand right arm
    .desc = The right arm of the Durand. It belongs on the mech chassis.
...
ent-GygaxHead = gygax head
    .desc = The head of the Gygax. It belongs on the mech chassis.
ent-GygaxLArm = gygax left arm
    .desc = The left arm of the Gygax. It belongs on the mech chassis.
ent-GygaxLLeg = gygax left leg
    .desc = The left leg of the Gygax. It belongs on the mech chassis.
ent-GygaxRLeg = gygax right leg
    .desc = The right leg of the Gygax. It belongs on the mech chassis.
ent-GygaxRArm = gygax right arm
    .desc = The right arm of the Gygax. It belongs on the mech chassis.
...
ent-RipleyLArm = ripley left arm
    .desc = The left arm of the Ripley APLU. It belongs on the mech chassis.
ent-RipleyLLeg = ripley left leg
    .desc = The left leg of the Ripley APLU. It belongs on the mech chassis.
ent-RipleyRLeg = ripley right leg
    .desc = The right leg of the Ripley APLU. It belongs on the mech chassis.
ent-RipleyRArm = ripley right arm
    .desc = The right arm of the Ripley APLU. It belongs on the mech chassis.
...
ent-HamtrLArm = HAMTR left arm
    .desc = The left arm of the HAMTR. It belongs on the mech chassis.
ent-HamtrLLeg = HAMTR left leg
    .desc = The left leg of the HAMTR. It belongs on the mech chassis.
ent-HamtrRLeg = HAMTR right leg
    .desc = The right leg of the HAMTR. It belongs on the mech chassis.
ent-HamtrRArm = HAMTR right arm
    .desc = The right arm of the HAMTR. It belongs on the mech chassis.
