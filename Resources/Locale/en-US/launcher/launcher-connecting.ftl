...
connecting-discord-auth-reauth = Reauthorize Discord
connecting-discord-auth-retry = Retry Discord Check
connecting-discord-auth-retry-cooldown = Retry Discord Check ({ $seconds }s)
