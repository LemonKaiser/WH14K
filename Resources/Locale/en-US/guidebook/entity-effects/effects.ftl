...
entity-effect-guidebook-status-effect =
    { $type ->
        [update]{ $chance ->
                    [1] Causes
                    *[other] cause
                 } {$name} for at least {NATURALFIXED($time, 3)} {MANY("second", $time)} without accumulation
        [add]   { $chance ->
                    [1] Causes
                    *[other] cause
                } {$name} for at least {NATURALFIXED($time, 3)} {MANY("second", $time)} with accumulation
        [set]  { $chance ->
                    [1] Causes
                    *[other] cause
                } {$name} for at least {NATURALFIXED($time, 3)} {MANY("second", $time)} without accumulation
        *[remove]{ $chance ->
                    [1] Removes
                    *[other] remove
                } {NATURALFIXED($time, 3)} {MANY("second", $time)} of {$name}
    } { $delay ->
        [0] immediately
