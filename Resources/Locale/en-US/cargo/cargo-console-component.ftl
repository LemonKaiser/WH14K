...
cargo-console-menu-delivery-time-label = Delivery duration:{" "}
cargo-console-menu-delivery-time-none-text = unavailable
cargo-console-menu-delivery-time-arriving-text = arriving...
cargo-console-menu-delivery-time-value = {$time}
