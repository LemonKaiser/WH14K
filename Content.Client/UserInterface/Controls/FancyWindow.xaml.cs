...
namespace Content.Client.UserInterface.Controls
{
    ...
    public partial class FancyWindow : BaseWindow
    {
        ...
        internal void ApplyConfiguredWindowOpacity(float opacity)
        {
            WindowOpacityHelper.ApplyPanelOpacity(WindowBackgroundPanel, opacity);
            WindowOpacityHelper.ApplyPanelOpacity(WindowHeader, opacity);
            WindowOpacityHelper.ApplyPanelOpacity(WindowDivider, opacity);
            WindowOpacityHelper.ApplyPanelOpacity(
                WindowContentsBackdrop,
                WindowOpacityHelper.ResolveReadableBackdropOpacity(opacity),
                Color.FromHex("#090B10"));
            WindowOpacityHelper.ApplySelfModulateOpacity(WindowCenterLogoRect, opacity);
        }
