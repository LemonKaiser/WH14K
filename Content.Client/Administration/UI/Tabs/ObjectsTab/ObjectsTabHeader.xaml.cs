...
namespace Content.Client.Administration.UI.Tabs.ObjectsTab
{
    ...
    public sealed partial class ObjectsTabHeader : Control
    {
        ...
        {
            ObjectNameLabel.FontColorOverride = color;
            EntityIDLabel.FontColorOverride = color;
            EntityTeleportLabel.FontColorOverride = color;
            EntityDeleteLabel.FontColorOverride = color;
        }
