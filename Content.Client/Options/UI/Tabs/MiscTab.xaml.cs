...
public sealed partial class MiscTab : Control, ILocalizedControl
{
    ...
    public MiscTab()
    {
        ...
        _themeOption = Control.AddOptionDropDown(CVars.InterfaceTheme, DropDownHudTheme, BuildThemeEntries());
    ...
    private IReadOnlyCollection<OptionDropDownCVar<string>.ValueOption> BuildThemeEntries()
    {
        ...
        var themeEntries = new List<OptionDropDownCVar<string>.ValueOption>(themes.Count);
