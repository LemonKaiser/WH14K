...
namespace Content.Client.ContextMenu.UI
{
    ...
    public sealed partial class ContextMenuPopup : Popup
    {
        ...
        public ContextMenuPopup (ContextMenuUIController uiController, ContextMenuElement? parentElement) : base()
        {
            ...
            _cfg.OnValueChanged(CCVars.UiWindowOpacity, ApplyConfiguredOpacity, true);
        ...
        {
            if (disposing)
                _cfg.UnsubValueChanged(CCVars.UiWindowOpacity, ApplyConfiguredOpacity);
        ...
        private void ApplyConfiguredOpacity(float opacity)
        {
            WindowOpacityHelper.ApplyPanelOpacity(MenuPanel, opacity);
        }
    }
}
