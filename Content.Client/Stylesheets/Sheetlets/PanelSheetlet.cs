...
public sealed class PanelSheetlet<T> : Sheetlet<T> where T : PalettedStylesheet, IButtonConfig
{
    public override StyleRule[] GetRules(T sheet, object config)
    {
        ...
        {
            BackgroundColor = sheet.PrimaryPalette.BackgroundLight.WithAlpha(0.92f),
        };
        var boxDark = new StyleBoxFlat()
        {
            BackgroundColor = sheet.PrimaryPalette.BackgroundDark.WithAlpha(0.9f),
        };
        ...
        [
            ...
            E<PanelContainer>()
                ...
                .Prop(PanelContainer.StylePropertyPanel, new StyleBoxFlat(sheet.PrimaryPalette.BackgroundDark.WithAlpha(0.9f))),
            ...
            E()
                ...
                .Modulate(sheet.PrimaryPalette.Background),
            E()
