...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> WH40KConnectionFallbackEnabled =
        CVarDef.Create("wh40k.connection_fallback.enabled", true, CVar.CLIENTONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<string> WH40KConnectionFallbackPrimaryAddresses =
        CVarDef.Create("wh40k.connection_fallback.primary_addresses", "ss14://ebengrad.node-oheir.simplestation.org:25910", CVar.CLIENTONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<string> WH40KConnectionFallbackAlternateAddresses =
        CVarDef.Create("wh40k.connection_fallback.alternate_addresses", "ss14://heretec.online:25910", CVar.CLIENTONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<bool> WH40KConnectionFallbackAutomatic =
        CVarDef.Create("wh40k.connection_fallback.automatic", true, CVar.CLIENTONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<bool> WH40KConnectionFallbackButtonEnabled =
        CVarDef.Create("wh40k.connection_fallback.button_enabled", true, CVar.CLIENTONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<float> WH40KConnectionFallbackAutoDelaySeconds =
        CVarDef.Create("wh40k.connection_fallback.auto_delay_seconds", 1.0f, CVar.CLIENTONLY | CVar.ARCHIVE);
