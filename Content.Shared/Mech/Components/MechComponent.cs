...
public sealed partial class MechComponent : Component
{
    ...
    /// </summary>
    [DataField]
    public ProtoId<AlertPrototype> BatteryAlert = "MechBattery";

    /// <summary>
    /// Alert to show when the mech has no battery installed.
    /// </summary>
    [DataField]
    public ProtoId<AlertPrototype> NoBatteryAlert = "MechBatteryNone";

    /// <summary>
    /// Passive battery drain while a pilot is seated, even if the mech is idle.
    /// </summary>
    [DataField, AutoNetworkedField]
    public float PilotPassiveEnergyPerSecond = 1f;
