...
public sealed partial class MotionDetectorComponent : Component, IDetectorComponent
{
    ...
    [DataField, AutoNetworkedField]
    public TimeSpan ShortRefresh = TimeSpan.FromSeconds(3);

    [DataField, AutoNetworkedField]
    public TimeSpan LongRefresh = TimeSpan.FromSeconds(10);

    [DataField, AutoNetworkedField]
    public TimeSpan MoveTime = TimeSpan.FromSeconds(2);

    [DataField, AutoNetworkedField]
    public float ShortMoveDistance = 4f;

    [DataField, AutoNetworkedField]
    public float LongMoveDistance = 6f;
