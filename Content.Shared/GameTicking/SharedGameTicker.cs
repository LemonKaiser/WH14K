...
namespace Content.Shared.GameTicking
{
    public abstract partial class SharedGameTicker : EntitySystem
    {
        ...
        public static readonly ProtoId<JobPrototype> FallbackOverflowJob = "Guardsman";

        public const string FallbackOverflowJobName = "job-name-guardsman";
    ...
    [Serializable, NetSerializable]
    public sealed class RequestLobbyInfoRefreshEvent : EntityEventArgs
    {
        public string? CultureName { get; }

        public RequestLobbyInfoRefreshEvent(string? cultureName = null)
        {
